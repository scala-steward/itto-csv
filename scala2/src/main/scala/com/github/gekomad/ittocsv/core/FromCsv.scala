...
object FromCsv {
  ...
  /** @param csv
    ...
    * @return
    *   `List[Either[NonEmptyList[ParseFailure], A]]` based on the parsing of `csv`, any errors are reported
    *   {{{
  ...
  /** @param csv
    ...
    *   the [[com.github.gekomad.ittocsv.parser.IttoCSVFormat]] formatter
    * @return
    *   `List[Either[ParseFailure, A]]` based on the parsing of `csv`, any errors are reported
    *   {{{
    * import com.github.gekomad.ittocsv.core.FromCsv._
    *
    * implicit val csvFormat = com.github.gekomad.ittocsv.parser.IttoCSVFormat.default
